...
public class EventFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        ((BaseActivity) getContext()).getNavigationView().getHeaderView(0).findViewById(R.id.background_menu).setBackgroundColor(getActivity().getResources().getColor(R.color.colorPrimary,null));
        ...
        Session.getInstance(getContext()).remove("color");
